...
#Score: 0.95203
"""
Created on Mon Sep 16 10:41:20 2019
...
model = Sequential()
model.add(Conv2D(filters=64, kernel_size=(3,3), activation='relu', input_shape=(n_timesteps,n_features, 1)))
...
df2.to_csv("y_pred_cnn_2D_100_features.csv", index=False)
